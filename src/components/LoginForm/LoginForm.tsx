...
export const LoginForm = () => {
  ...
  return (
    <div className="max-w-400 mx-auto flex flex-col items-center ">
      ...
      <p className="custom-before text-base text-grey w-full block relative text-center mb-8">
        OR
      </p>
      <form
      ...
      >
        <div className="w-full mb-6">
          ...
          />
          {errors.email && (
            <p className="w-full mt-2 text-sm text-red-400">
        ...
        <p className="text-xs mt-5">
          ...
          <span className="text-blue-light cursor-pointer">Sign up</span>
        </p>
      </form>
    </div>
  );
